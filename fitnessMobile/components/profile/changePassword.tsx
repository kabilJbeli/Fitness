...
const ChangePasswordComponent = (props: any) => {
  ...
  const updatePassword = () => {
    axios({
      method: "PUT",
      url: `${Environment.API_URL}/api/usersmanagement/updatePassword`,
      headers: {
      ...
      data: {
        ...
        password: state.password.previousPassword,
        newpassword: state.password.password
      },
      params: {}
    })
      .then(response => {
  ...
  return (
    <KeyboardAvoidingView
     contentContainerStyle={{backgroundColor:"#fff",height:"100%"}}
      behavior="position"
        ...
        <View style={{ width: "100%" }}>
          ...
          <Input
            ...
            onChangeText={(value: any) => setState((prevState: any) => {
              ...
              password.previousPassword = value;
              return { password };
            })}
            value={state.password?.previousPassword || ""}
